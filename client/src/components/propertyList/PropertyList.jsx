    ...
    return (
        <div className="propertyListContainer">
            <div className="propertyListItem">
                ...
                />
                <h2 className="pListTitles">Hotels</h2>
                <p className="pListSubTitle">878,257 hotels</p>
            </div>
            <div className="propertyListItem">
                <img
                    ...
                    className="pListImage"
                />
                <h2 className="pListTitles">Apartments</h2>
                <p className="pListSubTitle">909,144 apartments</p>
            </div>
            <div className="propertyListItem">
                <img
                    ...
                    className="pListImage"
                />
                <h2 className="pListTitles">Resorts</h2>
                <p className="pListSubTitle">18,023 resorts</p>
            </div>
            <div className="propertyListItem">
                <img
                    ...
                    className="pListImage"
                />
                <h2 className="pListTitles">Villas</h2>
                <p className="pListSubTitle">909,144 Villas</p>
            </div>
            <div className="propertyListItem">
                <img
                    ...
                    className="pListImage"
                />
                <h2 className="pListTitles">Cabins</h2>
                <p className="pListSubTitle">909,144 Cabins</p>
            </div>
        </div>
    );
}
